...
1. CentOS 7 install basic setting<br>
1.1 hostname<br>
1.2 firewalld<br>
1.3 timezone<br>
...
3. PATH add
4. ssh config
5. hadoop 2.7.7 install<br>
5.1. hadoop-env.sh<br>
5.2. yarn-env.sh<br>
5.3. core-site.xml<br>
5.4. hdfs-site.xml<br>
5.5. mapred-site.xml<br>
5.6. yarn-site.xml<br>
5.7. slave<br>
6. slave 배포<br>
6.1. hadoop config files / profile<br>
7. 실행 및 테스트<br>
